      ...
      <div className="flex items-center justify-between p-3 bg-background border-b border-border">
        <div className="flex items-center gap-3">
          <span className="text-xs font-medium text-text-primary">
            {t("preview:crop.title", "Crop Video")}
          </span>
          ...
          <IconButton
            label={t("preview:crop.reset", "Reset crop")}
        ...
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-background-secondary">
            <div className="text-text-muted text-sm">
              {t("preview:crop.loading", "Loading video...")}
            </div>
          </div>
        )}
        ...
        >
          {mediaType === "image" ? (
            <img
              ...
              alt={t("preview:crop.previewAlt", "Crop preview")}
            />
          ) : (
            <video
              ref={videoDisplayRef}
