    ...
    >
      <div className="flex items-center gap-2 p-2 bg-bg-2">
        <IconButton
          label={
            isOpen
              ? t("inspector:audioEffects.collapse", "Collapse {{title}}", {
                  title,
                })
              : t("inspector:audioEffects.expand", "Expand {{title}}", { title })
          }
          icon={
            <ChevronDown
              size={12}
        ...
        {onToggle && (
          <MockToggle
            ariaLabel={t(
              "inspector:audioEffects.enabledLabel",
              "{{title}} enabled",
              { title },
            )}
            checked={enabled}
    ...
    <div className="space-y-3">
      <Card variant="muted" padding={2} className="flex items-center gap-2">
        ...
        <Text type="supporting" color="secondary" className="text-[10px]">
          {t("inspector:audioEffects.clip", "Audio clip:")}{" "}
          {clipId.substring(0, 8)}...
        </Text>
      </Card>

      <SubSection
        title={t("inspector:audioEffects.equalizer", "Equalizer")}
        enabled={eqEnabled}
      ...
      <SubSection
        title={t("inspector:audioEffects.compressor", "Compressor")}
        enabled={compressorEnabled}
        onToggle={handleCompressorToggle}
      >
        <div className="space-y-2">
          <EffectSlider
            label={t("inspector:audioEffects.threshold", "Threshold")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.ratio", "Ratio")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.attack", "Attack")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.release", "Release")}
      ...
      <SubSection
        title={t("inspector:audioEffects.reverb", "Reverb")}
        enabled={reverbEnabled}
        onToggle={handleReverbToggle}
      >
        <div className="space-y-2">
          <EffectSlider
            label={t("inspector:audioEffects.roomSize", "Room Size")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.damping", "Damping")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.wetDry", "Wet/Dry")}
      ...
      <SubSection
        title={t("inspector:audioEffects.delay", "Delay")}
        enabled={delayEnabled}
        onToggle={handleDelayToggle}
      >
        <div className="space-y-2">
          <EffectSlider
            label={t("inspector:audioEffects.time", "Time")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.feedback", "Feedback")}
          ...
          />
          <EffectSlider
            label={t("inspector:audioEffects.wetLevel", "Wet Level")}
