    ...
    <div className="border-t border-border p-2">
      <div className="relative rounded-lg border border-border bg-bg-2 transition-colors focus-within:border-accent">
        <ToolcraftTextAreaControl
          label={t("chat:composer.label", "AI edit request")}
          isLabelHidden
          value={text}
          onChange={setText}
          onKeyDown={onKeyDown}
          rows={2}
          placeholder={t("chat:composer.placeholder", "Ask the AI to edit your video…")}
        ...
        <div className="absolute bottom-1.5 right-1.5">
          {busy ? (
            <IconButton
              label={t("chat:composer.stop", "Stop")}
            ...
            <IconButton
              label={t("chat:composer.send", "Send")}
