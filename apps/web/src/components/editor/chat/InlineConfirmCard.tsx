  ...
  return (
    <div className="rounded-lg border border-status-warning/40 bg-status-warning/10 p-2.5 text-[12px]">
      <div className="mb-1 flex items-center gap-1.5 font-medium text-fg">
        ...
        {t("chat:confirm.title", "Confirm action")}
      </div>
      <Text type="supporting" color="secondary" className="mb-2 text-fg-2">
        {t("chat:confirm.bodyPrefix", "The assistant wants to run")}{" "}
        <span className="font-mono text-fg">{call.name}</span>
        {t(
          "chat:confirm.bodySuffix",
          ", which may modify your project or incur cost.",
        )}
      </Text>
      {argKeys.length > 0 && (
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        <Button
          label={t("chat:confirm.approve", "Approve")}
          variant="primary"
          size="sm"
        ...
        />
        <Button
          label={t("chat:confirm.approveForTurn", "Approve all this turn")}
          variant="secondary"
          size="sm"
        ...
        />
        <Button
          label={t("chat:confirm.reject", "Reject")}
          variant="destructive"
          size="sm"
