    ...
    return (
      <div className="h-full flex items-center justify-center text-text-muted">
        <Text type="body" color="secondary" className="text-sm">
          {t("keyframeEditor.selectClip", "Select a clip with keyframes to edit")}
        </Text>
      </div>
    );
  }
    ...
    <div className="h-full flex flex-col bg-background-secondary border-l border-border">
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <Text type="body" weight="bold" className="text-sm">
          {t("keyframeEditor.title", "Keyframe Editor")}
        </Text>
        <IconButton
          label={t("keyframeEditor.close", "Close keyframe editor")}
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-border bg-background-tertiary">
        <Selector
          label={t("keyframeEditor.property", "Property")}
          isLabelHidden
        ...
        <Button
          label={t("keyframeEditor.copy", "Copy")}
          variant="ghost"
          size="sm"
        ...
        />
        <Button
          label={t("keyframeEditor.paste", "Paste")}
          variant="ghost"
          size="sm"
        ...
        />
        <Button
          label={t("keyframeEditor.delete", "Delete")}
          variant="ghost"
          size="sm"
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <Text type="supporting" color="secondary" className="text-xs">
              {t("keyframeEditor.easing", "Easing:")}
            </Text>
            <Selector
              label={t("keyframeEditor.easingLabel", "Easing")}
              isLabelHidden
          ...
          <Text type="supporting" color="secondary" className="text-xs">
            {t("keyframeEditor.keyframesSelected", "{{count}} keyframe selected", { count: selectedKeyframeIds.length })}
          </Text>
        </div>
      </div>
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="text-text-muted">
                  <th className="text-left py-1 px-2">{t("keyframeEditor.tableTime", "Time")}</th>
                  <th className="text-left py-1 px-2">{t("keyframeEditor.tableValue", "Value")}</th>
                  <th className="text-left py-1 px-2">{t("keyframeEditor.tableEasing", "Easing")}</th>
                </tr>
              </thead>
              <tbody>
